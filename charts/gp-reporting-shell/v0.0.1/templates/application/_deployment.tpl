...
kind: Deployment
metadata:
  name: gitprime-reporting-shell-{{- template "helpers.environment.fullName" .}}-{{ .templateData.operationMode }}
  labels:
    app: gitprime-reporting-shell-{{- template "helpers.environment.fullName" .}}-{{ .templateData.operationMode }}
spec:
...
kind: Service
metadata:
  name: gitprime-reporting-shell-{{- template "helpers.environment.fullName" .}}-{{ .templateData.operationMode }}-nodeport
  labels:
    app: gitprime-reporting-shell-{{- template "helpers.environment.fullName" .}}-{{ .templateData.operationMode }}
spec:
  type: NodePort
